...
namespace UsefulSites.DataAccess.Migrations.ApplicationDb
{
    ...
    [Migration("20180701093416_AddSeedData")]
            ...
            modelBuilder.Entity("UsefulSites.DataAccess.Data.ResourceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2018, 7, 1, 10, 34, 16, 155, DateTimeKind.Local), Name = "Web Site", UpdatedDate = new DateTime(2018, 7, 1, 10, 34, 16, 158, DateTimeKind.Local) }
                    );
                });
