...
namespace UsefulSites.DataAccess.Migrations.ApplicationDb
{
    ...
    [Migration("20180701105943_DescriptionForResourceType")]
    partial class DescriptionForResourceType
    {
            ...
            modelBuilder.Entity("UsefulSites.DataAccess.Data.ResourceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2018, 7, 1, 11, 59, 43, 711, DateTimeKind.Local), Name = "Web Site", UpdatedDate = new DateTime(2018, 7, 1, 11, 59, 43, 715, DateTimeKind.Local) }
                    );
                });
